...
const  Hero = () => {
  ...
  return (
    <DivGrey id='jaca' className=' text-gray-300 min-h-screen flex  items-center justify-center'>
      <div className='bg-gradient-to-l bg-[#122455] align-center lg:pl-32 rounded-xl m-auto pt-0 px-10 lg:gap-10 min-h-[30rem] h-full flex w-[90%] lg:w-4/5 flex-col lg:flex-row items-center justify-center'>
        <div className='lg:w-1/2  w-full lg:mb-0 text-center items-center lg:text-left'>
          <div className='w-full mt-16 lg:mt-0 md:mt-8 sm:w-[30rem] leading-6 lg:mb-4 mx-auto lg:mx-0'>
            <motion.div
              ...
              ref={ref}
            >
              Jonathan Ayodele - Cybersecurity Professional
            </motion.div>
            <motion.div
              ...
              ref={ref}
            >
            Helping businesses Stay Cyber Resilient | Shaping a Safer Digital World through Cyber Education | Empowering Next Cyber Generation 
          ...
          <motion.div
            ...
            ref={ref}
          >
            <button  onClick={() => window.location.href = '#contact'} class="bg-[#5D5F70] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-xl mt-4 sm:mt-0">
              Let&apos;s talk
            </button>
          </motion.div>
        </div>
        <div className='lg:w-1/2 items-center justify-center hidden lg:block m-auto flex pb-32  w-full lg:mb-0 text-center lg:text-left'>
          <motion.img
            src='https://sample-57.s3.us-east-1.amazonaws.com/jonath-cyber/J-2.png'
